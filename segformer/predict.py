...
if __name__ == "__main__":
    ...
    #-------------------------------------------------------------------------#
    count           = False
    name_classes    = ["background", "tongue"]
    #----------------------------------------------------------------------------------------------------------#
    ...
    #----------------------------------------------------------------------------------------------------------#
    test_interval = 100
    fps_image_path  = r"D:\pycharm\program\Segmentation\segformer-pytorch-master\crop_img\0c1a27cd751b43f9ad8cdd8d5ba03388 (1).jpg"
    #-------------------------------------------------------------------------#
    ...
    #-------------------------------------------------------------------------#
    dir_origin_path = r"D:\pycharm\program\Segmentation\segformer-pytorch-master\crop_img"
    dir_save_path   = r"D:\pycharm\program\Segmentation\segformer-pytorch-master\result_crop"
    #-------------------------------------------------------------------------#
    ...
    onnx_save_path  = "logs/best_epoch_weights.pth"
